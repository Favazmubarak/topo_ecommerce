  ...
  return (
    <footer className="bg-[#0061A8] text-white py-20 px-8 md:px-12">
      <div className="max-w-[1400px] mx-auto">
        <div className="flex flex-col md:flex-row justify-between gap-16 mb-16 items-start">
          ...
          {/* Links and Contact Sections Wrapper */}
          <div className="flex flex-col md:flex-row gap-12 lg:gap-24">
            {/* Company Links */}
            <div className="flex flex-col gap-8 min-w-[120px]">
              <h4 className="font-bold text-lg tracking-tight">Company</h4>
              <ul className="flex flex-col gap-4 text-white/80 text-[17px]">
            ...
            <div className="flex flex-col gap-8 max-w-[300px]">
              <h4 className="font-bold text-lg tracking-tight">Contact</h4>
              <ul className="flex flex-col gap-6 text-white/90 text-[17px]">
        ...
        <div className="border-t border-white/20 pt-8">
          {/* Optional: Add copyright or bottom links here if needed */}
        </div>
      </div>
    </footer>
  );
